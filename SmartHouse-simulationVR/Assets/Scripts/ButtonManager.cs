...
{ 
    ...
    public bool showSmartphone = false;
    ...
    void Start()
    {
        ...
        handRender = hand.gameObject.transform.GetChild(5).gameObject;
    ...
    void Update()
    {
        ...
        if (showSmartphone)
        {
            ...
            hand.AttachObject(Smartphone, GrabTypes.Pinch);
        } 
        else
        {
